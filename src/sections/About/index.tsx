        ...
        <div className="grid grid-cols-2 gap-40 py-20">
          ...
          <div>
            ...
            <div className="mt-5">
              ...
              <span className="text-[#D9DCE3] px-3">Ahmed Maher Ahmed Ali</span>
            </div>
            <div className="mt-5">
              <span className="text-[#1DCBB2] font-bold">Date Of Birth:</span>
              <span className="text-[#D9DCE3] px-3">1-12-1993</span>
            </div>
            <div className="mt-5">
              <span className="text-[#1DCBB2] font-bold">Nationality:</span>
              <span className="text-[#D9DCE3] px-3">Egyptian</span>
            </div>
            <div className="mt-5">
              <span className="text-[#1DCBB2] font-bold">Phone:</span>
              <span className="text-[#D9DCE3] px-3">+20-1124-424-195</span>
              <span className="text-[#D9DCE3] px-3">+20-1017-508-153</span>
            </div>
            <div className="mt-5">
              <span className="text-[#1DCBB2] font-bold">Email:</span>
              <span className="text-[#D9DCE3] px-3">
